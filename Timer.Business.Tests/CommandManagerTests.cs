...
namespace Timer.Tests
{
    ...
    public class CommandManagerTests
    {
        ...
        public void AddCommand()
        {
            ...
            //commandManager.AddWriterCommand(new StartTaskCommand { TimeStamp = new DateTime(2020, 1, 1), Description="Test", TicketId="TicketId" });

            //Assert.That(insertedEntity, Is.Not.Null);
            //Assert.That(insertedEntity.TimeStamp, Is.EqualTo(now));
            //Assert.That(typeof(TimerCommand).Assembly.GetType(insertedEntity.Type), Is.EqualTo(typeof(StartTaskCommand)));
